...
Each section of code should run in about a minute or less. Running the entire script from start to finish (by choosing to Run All Chunks) should take a two to five minutes. 
